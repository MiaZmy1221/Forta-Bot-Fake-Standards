...
w3 = Web3Mock()
API_KEY = "" # use your own key from alchemy

# Test case: 0x2325f3a51f87d80932224ef121f7884c9b1812b22a061979df5331b9caad43d2
class TestFakeStandardsAgent:
    ...
    def test_alchemy_simulate_transaction(self):
        ...
        match_flag, real_logic = agent.alchemy_simulate_transaction(API_KEY, proxy, logic_at_storage)
    ...
    def test_fake_standards(self):
        ...
        created_contract_addresses = agent.detect_contract_creations(w3, tx_event)
        findings = agent.fake_standards(API_KEY, created_contract_addresses)
